...
const props = defineProps({
  id: { type: [String, Number], default: 'file-input' },
...
<template>
  <div>
    ...
    <input
      ...
      class="block w-full text-sm text-zinc-800 dark:text-zinc-200 bg-zinc-200 dark:bg-zinc-800 file:py-2.5 file:px-4 file:rounded-l-lg file:border-0 file:bg-zinc-300 dark:file:bg-zinc-700 file:text-zinc-800 dark:file:text-zinc-200 hover:file:bg-zinc-400/80 dark:hover:file:bg-zinc-600/80 border rounded-lg"
      :class="borderClasses"
    />
