...
import ActuDetail from '@/components/pages/public/actu/ActuDetail.vue'
...
const actus = [
    ...
    },
    {
        ...
        excerpt:
            'Les étudiants peuvent désormais postuler au nouveau programme de bourses 2025-2026.',
        icon: MegaphoneIcon,
...
const filteredActus = computed(() => {
    const filtered =
        activeFilter.value === 'Tous' ? actus : actus.filter((a) => a.type === activeFilter.value)
    return filtered
})
    ...
    <PublicLayout>
        ...
        <Section>
            <SectionTitle
                ...
                subtitle="Communiqués, événements et annonces de la faculté"
            />
