...
<template>
    ...
    >
        ...
        <div class="relative z-10 px-4 mx-auto max-w-screen-xl text-center">
            ...
            <div
                class="mt-8 flex flex-col space-y-4 gap-4 sm:flex-row sm:justify-center sm:space-y-0"
            >
                <Button as="router-link" to="/" size="lg" variant="primary">
                    Nous découvrir
                </Button>
                <Button
                    as="router-link"
                    ...
                    class="group"
                >
                    <span class="group-hover:text-zinc-200">Nous rejoindre</span>
                </Button>
            </div>
        </div>

        <div
            class="absolute bottom-0 left-0 w-full h-full bg-gradient-to-t from-primary-800/50 via-transparent to-primary-800/25"
        ></div>
    </section>
</template>
